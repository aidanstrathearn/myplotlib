...
const GENERATED_NOTICE: &str = "// Generated by cargo-myplotlib; do not edit.\n\n";
...
fn write_web_assets(out_dir: &Path) -> Result<(), Error> {
    ...
    write_asset(
        ...
        &format!("{GENERATED_NOTICE}{LOADER_JS}"),
    )?;
    write_asset(
        &out_dir.join("app.js"),
        &format!("{GENERATED_NOTICE}{APP_JS}"),
    )?;
    Ok(())
}
...
mod tests {
    ...
    fn writes_the_public_entry_and_private_loader() {
        ...
        assert!(app.starts_with(GENERATED_NOTICE));
        assert!(app.contains("export function mount"));
        assert!(app.contains("./bindings.js"));
        assert!(loader.starts_with(GENERATED_NOTICE));
